                        ...
                        <div class="panel-body">
                            <form role="form">
                                        <div class="form-group">
                                            ...
                                            <input class="form-control" required="" type="text" placeholder="Köhnə parolu daxil edin" name="hesab_kohnaparol">
                                        </div>
                                        <div class="form-group">
                                            <label>Yeni Parol</label>
                                            <input class="form-control" required="" placeholder="Yeni parolu daxil edin" type="text" name="hesab_yeniparol">
                                        </div>                                
                                                               
                                        <button style="margin-top: 10px;width: 100%;" type="submit" class="btn btn-info" name="hesab_duzaliset_parol">YENİLƏ </button>
                                    </form>
                            </div>
                        </div>
            </div>
